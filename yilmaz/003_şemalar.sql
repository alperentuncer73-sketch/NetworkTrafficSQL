...
-- monitoring.traffic_logs tablosu --
...
-- Son Kontrol --
SELECT TABLE_SCHEMA, TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA IN ('network', 'monitoring');
PRINT 'Hafta 3 tamamlandı.';
GO

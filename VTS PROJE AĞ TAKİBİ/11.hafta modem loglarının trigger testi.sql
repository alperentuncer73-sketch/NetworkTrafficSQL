USE [Ag takibi proje];
GO
-- modem loglarını sisteme yükleyelim
...
-- eðer protokol ID'leri null gelirse varsayılan 1 ve 2 yapalım (hata önleyici)
...
-- yüklediğimiz verilerin sistem tarafından yakalanýp yakalanmadığını check edelim
